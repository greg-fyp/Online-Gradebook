				...
				<nav style='min-height: 60px;' class='navbar navbar-dark bg-dark fixed-top navbar-expand-md'>
					...
					<div class='collapse navbar-collapse' id='menubar'>
						<ul class='navbar-nav'>
							...
							<li class='nav-item'>
								<a class='nav-link' href='$target_file?route=pricing'>Pricing</a>
							</li>
							<li class='nav-item'>
								<a class='nav-link' href='$target_file?route=contact'>Contact Us</a>
							</li>
							<li class='nav-item'>
						...
						<div class='ml-auto'>
							...
							<a href='$target_file?route=user_login' style='color: lightgrey; text-decoration: none;'>Login</a></button>
							<button class='btn btn-info'>
							<a href='$target_file?route=register' style='color: white; text-decoration: none;'>Get Started</a></button>
						</div>
					</div>
				</nav>
			</header>
